 ...
 *
 * v1.0
 * Copyright (C) 2003 by Gufino <bugsman@libero.it>
 *
 * v2.0 - v2.3
 * Copyright (C) 2009, 2012, 2015, 2021 by Ivo van Poorten <ivop@free.fr>
 *
...
static const char * const strings[256] = {
    ...
    "dex","ill", "cpy $%4.4x,x","cmp $%4.4x","dec $%4.4x","ill", "bne $%2.2x",
...
int main(int argc, char **argv) {
    ...
    fprintf(stderr,"SID/NSF/SAP Disassembler, Version 2.3\n");
    fprintf(stderr,"Copyright (C) 2003, Gufino/GufoSoft\n");
    fprintf(stderr,"Copyright (C) 2009, 2012, 2015, 2021 Ivo van Poorten\n");
    ...
    printf("; Generated by SID/NSF/SAP Disassembler, Version 2.3\n;\n");
    printf("; filename: %s\n\n", argv[1]);
